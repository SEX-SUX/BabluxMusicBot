...
BOT_USERNAME = getenv("BOT_USERNAME", "BabluxMusicBot")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/SEX-SUX/BabluxMusicBot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# ❖ SUPPORT AND CONTACT INFORMATION - PROVIDE YOUR OWN SUPPORT CHANNELS 
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+Y-4IVkPINUFiNDVl")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+Y-4IVkPINUFiNDVl")
